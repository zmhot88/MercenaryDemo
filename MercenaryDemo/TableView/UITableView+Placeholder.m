...
//  MercenaryDemo
//
//  Created by ross zhao on 2017/12/25.
...
//    else {
//        NSArray *nib = [[NSBundle mainBundle]loadNibNamed:@"PlaceholderView" owner:self options:nil];
//        PlaceholderView *view = [nib objectAtIndex:0];
...
- (UIView *)xy_defaultNoDataViewWithImage:(UIImage *)image message:(NSString *)message color:(UIColor *)color offsetY:(CGFloat)offset {
    ...
    NSArray *nib = [[NSBundle mainBundle]loadNibNamed:@"PlaceholderView" owner:self options:nil];
    PlaceholderView *view = [nib objectAtIndex:0];
//    PlaceholderView *view   = [[PlaceholderView alloc] init];
